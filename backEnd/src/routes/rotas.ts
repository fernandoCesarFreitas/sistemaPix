...
//listar
rotas.get("/lista", controller.list);

rotas.post("/pix", controller.pix);

rotas.post("/realizar", controller.create);
//gerar csv
// rotas.get("/csv", voluntarioController.gerarCSVVoluntarios);

// rotas.get("/email", voluntarioController.mandarEmail1);
